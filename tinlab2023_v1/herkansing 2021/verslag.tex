...
\titelblad                   %argumenten invullen
  {Een Uppaal `model' voor TinLAb} %hier titel invullen 
  ...
  {Dhr. Oelew}           %eerste docent
  {Mevr. Elivira }                         %tweede docent
...
\input{modelverslag} %(verplicht) hoofdverslag
\input{requirements} %(verplicht) hoofdverslag
\input{verificatie} %(verplicht) hoofdverslag
...
\else
  ...
  \appendix
  \include{brainstormdocument}   %(optioneel) brainstormdocument
