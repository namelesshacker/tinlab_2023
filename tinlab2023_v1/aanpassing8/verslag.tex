...
\tikzset{
    mynode/.style={
        draw, rectangle, align=center, text width=4cm, font=\small, inner sep=3ex},
    mylabel/.style={
...
\begin{tikzpicture}[
    ...
    \begin{scope}[start chain=going below, xshift=-7cm, node distance=.8cm]
    ...
    % the title
    \node[above=2.5cm of tc, font=\bf] {Sytematisch literatuur overzicht};
\end{tikzpicture}
...
\begin{center}
  \begin{tabular}{ l | c || r | }
    ...
    3 & 2,173 tonnes  &  flammable liquids, flammable solids, substances\\   % that emit flammable gases when contact with water and oxidising substances 
4 & 1,831 tonnes  &  Toxic and corrosive substances,  \\  %and other hazardous chemicals
    \hline
  \end{tabular}
\end{center}
