...
\begin{center}
	\figuur{width=\columnwidth}{plaatjes/cvi\_systeem\_oud.png}{PNGR}{Variabele breedte (png)}
\end{center}
...
\begin{center}
	\figuur{width=\columnwidth}{plaatjes/esp\_idf\_setup.png}{PNGR}{Variabele breedte (png)}
\end{center}
...
In het onderstaande afbeelding de display van het type nexus waarop informatie wordt getoond zoals de naam van de netwerkverbinding waarop het device communiceert met de cloud. Het display toont verder belangrijke informatie zoals de temperatuur van de cvi en eventuele storingen



\begin{center}
	\figuur{width=\columnwidth}{plaatjes/nexxion\_user\_display.png}{PNGR}{Variabele breedte (png)}
\end{center}


\begin{center}
	\figuur{width=\columnwidth}{plaatjes/ti\_green.png}{PNGR}{Variabele breedte (png)}
\end{center}



\begin{center}
	\figuur{width=\columnwidth}{plaatjes/hardwre\_compleet.png}{PNGR}{Variabele breedte (png)}
\end{center}
...
\begin{figure}[!tbp]
	\centering
	\subfloat[Flower one.]{\includegraphics[width=0.3\textwidth]{flower1.jpg}\label{fig:f1}}
	\hfill
	\subfloat[Flower two.]{\includegraphics[width=0.3\textwidth]{flower2.jpg}\label{fig:f2}}
	\caption{My flowers.}
	\subfloat[Flower one.]{\includegraphics[width=0.33\textwidth]{flower1.jpg}\label{fig:f1}}
	\hfill
	\subfloat[Flower two.]{\includegraphics[width=0.3\textwidth]{flower2.jpg}\label{fig:f2}}
	\caption{My flowers.}
\end{figure}
...
Een 3-fase opstelling zoals het systeem op dit moment wordt geleverd bij de klant. Met deze testopstelling wordt het product getest zoals deze daadwerkelijk bij de klant in gebruik is. Voor de proefopstelling wordt dummy data gegenereerd en gepubliceerd voor de telemetry omdat we de systemen bij de klant niet kunnen testen op afstand en ook niet op locatie.
...
de registratie van werkzaamheden tijdens het afstudeerproject. Dit
voorkomt dat men dingen vergeet.
\section{Selectie strategie research papers}
Om een goed verhaal op te stellen, moet vooraf aan enkele voorwaarden
worden voldaan. De eerste voorwaarde is de geschiktheid van het
afstudeerproject. Als een afstudeerproject niet tot keuzes leidt, kan
men zich afvragen of dat wel een echte afstudeeropdracht is. Een
...
%\input{bedrijf} %(verplicht) hoofdverslag
\chapter{bedrijf}
\section{Algemeen}
 ...
 \section{Inleiding}
%\include{achtergrond}   %(optioneel) Vooronderzoek

%\include{onderzoek}   %(optioneel) bepaling_uitgangsmodel
...
\subsection{privacy en security}
...
\begin{center}
	\figuur{width=\columnwidth}{plaatjes/protocolstack.png}{PNGR}{Variabele breedte (png)}
\end{center}
...
\begin{frame}{protocol vergelijking}
	\begin{table}[htbp]
		\centering
		\begin{tabular}{|c|c|c|c|}\hline
...
\subsection{deadlocks}
	...
	% Insert the following commented line before \begin{document}:
		...
		\begin{center}
			\figuur{width=\columnwidth}{plaatjes/IoTAPP\_watchdog\_error.png}{PNGR}{Variabele breedte (png)}
		\end{center}
	...
	\chapter{Conclusie}
		...
		%	\include{discussie}   %(optioneel) uitwerking_ontwerp_detail
		...
		\begin{center}
			\figuur{width=\columnwidth}{plaatjes/dns\_settings.png}{PNGR}{Variabele breedte (png)}
		\end{center}
		...
		\begin{center}
			\figuur{width=\columnwidth}{plaatjes/tb\_rpc\_button.png}{PNGR}{Variabele breedte (png)}
		\end{center}
		
		
		
		\begin{center}
			\figuur{width=\columnwidth}{plaatjes/rpc\_audit\_backlog.png}{PNGR}{Variabele breedte (png)}
		\end{center}
		
		
		
		\begin{center}
			\figuur{width=\columnwidth}{plaatjes/rpc\_audit\_details.png}{PNGR}{Variabele breedte (png)}
		\end{center}
		
		
		
		\begin{center}
			\figuur{width=\columnwidth}{plaatjes/rpc\_buttons.png}{PNGR}{Variabele breedte (png)}
		\end{center}
		
		
		
		\begin{center}
			\figuur{width=\columnwidth}{plaatjes/rpc\_data\_editing.png}{PNGR}{Variabele breedte (png)}
		\end{center}
		...
		de registratie van werkzaamheden tijdens het afstudeerproject. Dit
		voorkomt dat men dingen vergeet.
		\include{Dashboard provisioning}   %(optioneel) besluit
		...
		% Insert the following commented line before \begin{document}:
			...
			\include{resultaten zoekopdracht}
	...
	%	\include{testresultaten}   %(optioneel) testresultaten
	...
	%\include{testresultaten}   %(optioneel) Methoden
	%\hoofdstuk{Testresultaten}