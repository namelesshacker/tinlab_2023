...
Het is mij niet gelukt de wiskundigee notitie van clocked ctl formulae te specificeren voor modelel checking. Het is wel gelukt de operatoren ,E<G<F en X te grbruiken voor de definitie van onze specificaties.
 Tijdens ons ozneroek naar de clock zones en regios's zijn we in artikel . \cite{04_giWorkshop2000}
 \cite{pelanekFormal} 
