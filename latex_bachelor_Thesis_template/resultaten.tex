...
\begin{tikzpicture}[>=latex',shorten >=1pt,node distance=1.5cm,on grid,auto]
...
\node[state] (11)  [ above right =of 3]   {$q10$};
\node[state] (12)  [ below right =of 3]   {$q10$};
\node[state] (4)  [ below =of 11]   {$q4$};
\node[state] (5)  [ right =of 4]   {$q5$};
\node[state] (6)  [ right =of 5]   {$q6$};
\node[state] (7)  [ right =of 6]   {$q7$};
\node[state] (8)  [ right =of 7]   {$q8$};
\node[state] (9)  [ right =of 8]   {$q9$};
\node[state] (10)  [ right =of 8]   {$q10$};
\end{tikzpicture}
...
\begin{tikzpicture}[->,>={Stealth[round]},shorten >=1pt,%
	...
	\node[state]         (A) [ right=of 3] {$A$};
	\node[state]         (B) [above right=of A] {$B$};
	\node[state]         (D) [below right=of A] {$D$};
	\node[state]         (C) [below right=of B] {$C$};
	\node[state]         (E) [below=of D]       {$E$};
	\node[state] (6) [ right=of C] {$6$};
	\node[state] (7) [ right=of 6] {$7$};
	\node[state] (8) [ below=of 6] {$8$};
	\node[state] (8) [ below=of B] {$8$};
