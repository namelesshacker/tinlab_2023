...
\subsubsection{ Research case: De digitale aanval op de Oekrainese krachtcentrale}
...
\cite{Whitehead2017ukrainepoweroutage}
\cite{boozallen2016lightwentout}
\paragraph{spearfishing}
\paragraph{blackenergy}
\paragraph{remote access capabilities}
\paragraph{serial-to-ethernet communication devices}
\paragraph{telephony denial of service attacks}
...
\paragraph{Notities die verwerkt moeten worden}
...
\paragraph{invaardeuren en uitvaardeuren}
...
\paragraph{invaarstoplicht en uitvaarstoplicht}
...
\paragraph{invaarwachtrij en uitvaarwachtrij}
...
\paragraph{Sluisdeuren en stoplichten}
...
\paragraph{Requirements voor Het sluismodel}
...
\paragraph{Uppaal kripke structuren}
...
\paragraph{Het vier variabelen model}
Systemen (met daarin software) en de bijbehorende vier variabelen:
\paragraph{Monitored variabelen}
: door sensoren gekwanticeerdefenomenen uit de omgeving
\paragraph{Controlled variabelen}
door actuatoren bestuurde fenomenen uit de omgeving
\paragraph{Input variabelen}
\paragraph{Output variabelen}




\paragraph{Aankomst, uitvoering, vrijgave}
