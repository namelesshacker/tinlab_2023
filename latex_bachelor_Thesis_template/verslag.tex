...
%\input{materiaal}    %(verplicht) inleiding
%\input{methode}    %(verplicht) inleiding
\input{resultaten} %(verplicht) hoofdverslag
\input{discussie}   %(verplicht) geaggregeerde conclusies en aanbevelingen
%\input{aanbeveling}   %(verplicht) geaggregeerde conclusies en aanbevelingen
\typeout{} 
\ifpublic
...
\else
 ...
 % \include{bijlage4}   %(optioneel) bijlagen
 %  \include{bijlage5}   %(optioneel) bijlagen
  %\include{bijlage6}
 % \include{bijlage7}
 %   \include{bijlage8}
% \include {bijlage9}
% \include{bijlage10}
 % \include{bijlage11}   %(optioneel) bijlagen
